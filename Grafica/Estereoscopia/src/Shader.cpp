...
void Shader::loadShader(GLenum type, const char* source) {
	...
	shaders[type] = (type==VERTEX_SHADER)?glCreateShaderObjectARB(GL_VERTEX_SHADER_ARB): (type==FRAGMENT_SHADER)?glCreateShaderObjectARB(GL_FRAGMENT_SHADER_ARB) : glCreateShaderObjectARB(GL_GEOMETRY_SHADER_ARB);
