...
float Vec4D::Magnitud(void) const
{
...
float Vec4D::operator*(const Vec4D& v) const // Producto escalar
{
...
Vec4D operator*(float f, const Vec4D& v4Vec)
{
...
Vec4D operator*(const Vec4D& v4Vec, float f)
{
  Vec4D v4Tmp(f*v4Vec.coord[0], f*v4Vec.coord[1], f*v4Vec.coord[2], f*v4Vec.coord[3]);
